...
public:
    ...
    {
        StyleSheetEditor->setWindowTitle(QApplication::translate("StyleSheetEditor", "Style Editor"));
        styleSheetCombo->clear();
        styleSheetCombo->insertItems(0, QStringList()
         << QApplication::translate("StyleSheetEditor", "Default")
         << QApplication::translate("StyleSheetEditor", "Coffee")
         << QApplication::translate("StyleSheetEditor", "Pagefold")
         << QApplication::translate("StyleSheetEditor", "dw1")
         << QApplication::translate("StyleSheetEditor", "dw2")
         << QApplication::translate("StyleSheetEditor", "dw3")
         << QApplication::translate("StyleSheetEditor", "dw4")
         << QApplication::translate("StyleSheetEditor", "dw5")
         << QApplication::translate("StyleSheetEditor", "dw6")
         << QApplication::translate("StyleSheetEditor", "dw7")
        );
        label_7->setText(QApplication::translate("StyleSheetEditor", "Style:"));
        applyButton->setText(QApplication::translate("StyleSheetEditor", "&Apply"));
        label_8->setText(QApplication::translate("StyleSheetEditor", "Style Sheet:"));
    } // retranslateUi
